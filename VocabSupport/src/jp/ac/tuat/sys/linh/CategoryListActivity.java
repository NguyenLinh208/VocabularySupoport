...
public class CategoryListActivity extends WordListBase<Integer> {
	...
	protected void setContentView() {
		setContentView(R.layout.activity_word_list_category);
	}
	@Override
	...
	private void modifyWord(WordEntity word) {
		// 修正画面に遷移
		Intent intent = new Intent(CategoryListActivity.this, RegisterActivity.class);
